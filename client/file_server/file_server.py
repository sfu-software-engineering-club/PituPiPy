...
class FileServer:
    ...
    def _send_file_transfer(self, receiver_ip_addr, receiver_port, chunk_start, chunk_end):
        ...
        try:
            ...
            with open(self.file_info.filepath, "rb") as file: # 'rb' -> reading in Binary mode
    ...
    def request_file(
        self, destination_filepath, sender_ip_addr, sender_port, chunk_start, chunk_end, file_identifier
    ):
        transfer_thread = threading.Thread(target=_request_file_transfer,
                                args=(destination_filepath, sender_ip_addr, sender_port, chunk_start, chunk_end, file_identifier))
        transfer_thread.start()

    def _request_file_transfer(
            destination_filepath, sender_ip_addr, sender_port, chunk_start, chunk_end, file_identifier
    ):
        ...
        with open(destination_filepath, "r+b") as requested_file: # reading & writing in Binary mode
